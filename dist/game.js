(() => {
  ...
  var ir, Hi, zi, rr, Ji, Qi, Nt, P, D, a, b, sr, or, $, lr, ar, T, N, L, Fe, de, ue, v, fr, k, R, Zi, es, hr, be, $t, le, ke, ht, Be, fe, Tr, Sr, Cr, Rr, Wr, Mr, Lr, qr, Pr, Dr, ls, Ar, hs, Or, Ir, ds, fs, ps, ms, Ne, Vr, bt, Fr, ws, rn, je, gs, Us, sn, on2, ys, bs, no;
  ...
  var require_main = __commonJS({
    "code/main.js"(exports) {
      ...
      scene("battle", (spr) => {
        ...
        player.onStateEnter("normal", () => __async(exports, null, function* () {
          if (score >= 2e4) {
        ...
        __name(spawnBulletNormal, "spawnBulletNormal");
        function spawnBulletCone(p, m, spr2) {
          add([
            bulletdmg = 0.5,
            type = "cone",
            sprite(spr2),
        ...
        __name(spawnBulletCone, "spawnBulletCone");
        ...
        __name(spawnBulletBig, "spawnBulletBig");
        ...
        __name(spawnBulletCardinal, "spawnBulletCardinal");
        onKeyPress("space", () => {
          if (canShoot) {
        ...
        __name(spawnSadSmile, "spawnSadSmile");
        function spawnMan() {
          enemydmg = 33;
          value = 1e3;
          add([
        ...
        onUpdate(() => {
          if ((score % 1e3 == 0 || score % 1e3 == 50) && score != 0) {
            spawnBulletPowerUp();
            score += 100;
          }
        ...
        __name(spawnHealOrb, "spawnHealOrb");
        ...
        __name(spawnBulletPowerUp, "spawnBulletPowerUp");
        ...
        __name(spawnShieldPowerUp, "spawnShieldPowerUp");
        ...
        __name(spawnShield, "spawnShield");
        ...
        __name(spawnRandomPowerUp, "spawnRandomPowerUp");
        loop(15, () => {
          spawnRandomPowerUp();
        });
        ...
        function makeStopwatch(time2, x, y) {
          const timer2 = add([
            text(0),
            scale(1),
            pos(x, y),
          ...
          timer2.onUpdate(() => {
            timer2.time -= dt();
            timer2.text = timer2.time.toFixed(2);
          });
          wait(time2, () => {
            destroy(timer2);
            active = false;
        ...
        onCollide("bullet", "enemy", (b2, e) => {
          destroy(b2);
          e.hurt(bulletdmg);
          addExplode(b2.pos, 1, 12, 1);
        });
        on("death", "enemy", (e) => {
          play("edeath");
          destroy(e);
        ...
        player.onCollide("enemybullet", (b2) => {
          destroy(b2);
        ...
        function spawnBoss() {
          ...
          boss.onStateEnter("idle", () => __async(this, null, function* () {
            if (boss.hp() > 0) {
              boss.enterState("moveattack");
            }
          }));
          boss.onStateEnter("moveattack", () => __async(this, null, function* () {
            if (player.exists()) {
